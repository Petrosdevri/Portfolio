...
import { Sidevdotto as Devto, Sihashnode as Hashnode, Siprotonmail as ProtonMail } from '@icons-pack/react-simple-icons';
...
export default function Footer() {
    ...
    const [color, setColor] = useState(['#fff', '#fff', '#fff', '#fff', '#fff', '#fff']);
    const [bgColor, setBgColor] = useState(['#1F2933', '#1F2933', '#1F2933', '#1F2933', '#1F2933', '#1F2933']);
    ...
    const onMouseOut = () => {
        setColor(['#fff', '#fff', '#fff', '#fff', '#fff', '#fff']);
        setBgColor(['#1F2933', '#1F2933', '#1F2933', '#1F2933', '#1F2933', '#1F2933']);
    };
            ...
            <Container fluid className='footer'>
                ...
                <Stack direction='horizontal' id='social-media-icons'>
                    <button className='footer-btn' style={{ background: `${bgColor[0]}` }} onMouseOver={() => onMouseOver(1)} onMouseOut={onMouseOut}>
                        <a href='https://dev.to/petrosdevri' target='_blank' rel='noreferrer'>
                            <LazyLoad height={35} once><Devto className='social-media-icon' color={color[0]} size='35' title='' /></LazyLoad>
                       </a>
                    </button>
                    ...
                    <button className='footer-btn' style={{ background: `${bgColor[2]}` }} onMouseOver={() => onMouseOver(3)} onMouseOut={onMouseOut}>
                        <a href='https://hashnode.com/@Petrosdevri' target='_blank' rel='noreferrer'>
                            <LazyLoad height={35} once><Hashnode className='social-media-icon' color={color[2]} size='35' title='' /></LazyLoad>
                        </a>
                    </button>
                    <button className='footer-btn' style={{ background: `${bgColor[3]}` }} onMouseOver={() => onMouseOver(4)} onMouseOut={onMouseOut}>
                        <a href='https://instagram.com/petrosdevri' target='_blank' rel='noreferrer'>
                            <LazyLoad height={35} once><UilInstagram className='social-media-icon' color={color[3]} size='35' /></LazyLoad>
                        </a>
                    </button>
                    <button className='footer-btn' style={{ background: `${bgColor[4]}` }} onMouseOver={() => onMouseOver(5)} onMouseOut={onMouseOut}>
                        <a href='https://www.linkedin.com/in/petros-devrikis/' target='_blank' rel='noreferrer'>
                            <LazyLoad height={35} once><UilLinkedin className='social-media-icon' color={color[4]} size='35' /></LazyLoad>
                        </a>
                    </button>
                    <button className='footer-btn' style={{ background: `${bgColor[5]}` }} onMouseOver={() => onMouseOver(6)} onMouseOut={onMouseOut}>
                        <a href='mailto:petrosdevrikis@proton.me' target='_blank' rel='noreferrer'>
                            <LazyLoad height={35} once><ProtonMail className='social-media-icon' color={color[5]} size='32' title='' /></LazyLoad>
                        </a>
                    </button>
                </Stack>
