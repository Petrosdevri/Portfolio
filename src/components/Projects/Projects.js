    ...
    return (
        <div className='projects'>
            <Stack className='project-stack' direction='horizontal' gap={5}>
                <ProjectCard title='ChadCoin' description='A Solidity ERC20 Meme Coin with a JavaScript frontend DApp.' picture={ChadCoin} code='https://github.com/Petrosdevri/ChadCoin' demo='https://github.com/Petrosdevri/ChadCoin#readme' />
                ...
                <ProjectCard title='Greek VAT Calculator' description='An HTML/CSS/JavaScript website to calculate VAT rates in Greece.' picture={GreekVATCalculator} code='https://github.com/Petrosdevri/Greek-VAT-Calculator' demo='https://greek-vat-calculator.vercel.app/' />
            </Stack>
            <Stack className='project-stack' direction='horizontal' gap={5}>
                ...
                <ProjectCard title='Product CRUD App' description='An Electron and MySQL sample app that can accept product inputs to a list, which is stored at a database.' picture='' code='https://github.com/Petrosdevri/Product-CRUD-App' demo='https://github.com/Petrosdevri/Product-CRUD-App' />
